...
const inPlugin: TaxFilingPlugin = {
   ...
   * GST slab (5 / 12 / 18 / 28%) depends on the HSN/SAC of the item.
   */
    ...
    return [
      {
        ...
        taxApplies: true,
        creditable: true,
        boxes: ['3.1(a)', 'IGST', 'CGST', 'SGST'],
        help: 'Taxable outward supplies at the applicable slab. Taxable value in 3.1(a); tax split into IGST (inter-state) or CGST + SGST/UTGST (intra-state).',
        authorityRef: ref,
        defaultFor: ['sales', 'services_income'],
      },
      {
        code: 'SALE_REDUCED',
        label: 'Outward taxable supplies (concessional slab)',
        side: 'sale',
        rate: null,
        taxApplies: true,
        creditable: true,
        boxes: ['3.1(a)', 'IGST', 'CGST', 'SGST'],
        help: 'Supplies at a lower slab (e.g. 5% or 12%). Reported with other taxable supplies in 3.1(a).',
        authorityRef: ref,
      },
      {
      ...
      },
      {
        ...
        taxApplies: true,
        creditable: true,
        boxes: ['ITC IGST', 'ITC CGST', 'ITC SGST'],
        help: 'Purchases from registered suppliers with GST charged; eligible ITC claimed in table 4 (IGST, or CGST + SGST/UTGST).',
        authorityRef: ref,
      },
      {
        ...
        creditable: true,
        boxes: ['ITC IGST', 'ITC CGST', 'ITC SGST'],
        help: 'Capital goods used for business; ITC claimed in table 4 (subject to rule 43 for mixed use).',
        authorityRef: ref,
        defaultFor: ['equipment', 'vehicles'],
      },
      {
        code: 'PURCHASE_REDUCED',
        label: 'Inward supplies at a concessional slab',
        side: 'purchase',
        rate: null,
        taxApplies: true,
        creditable: true,
        boxes: ['ITC IGST', 'ITC CGST', 'ITC SGST'],
        help: 'Purchases taxed at a lower slab; ITC claimed in table 4.',
        authorityRef: ref,
      },
      {
        ...
        creditable: false,
        boxes: [],
        help: 'Purchases from unregistered or composition suppliers, nil-rated and exempt inward supplies (bank charges, interest). No ITC; disclosed in table 5.',
        authorityRef: ref,
      ...
      },
      {
        ...
        creditable: false,
        boxes: [],
        help: 'ITC attributable to exempt supplies is reversed under rule 42/43 (table 4(B)).',
        authorityRef: ref,
      },
      {
        ...
        creditable: false,
        boxes: [],
        help: 'Blocked credits under section 17(5) (food and beverages, club memberships, personal vehicles) and personal-use portions. No ITC.',
        authorityRef: ref,
      ...
      },
      {
        ...
        taxApplies: true,
        creditable: true,
        boxes: ['3.1(d)', 'ITC IGST', 'ITC CGST', 'ITC SGST'],
        help: 'Purchases on which you pay GST under reverse charge (notified services, imports of services, unregistered suppliers where applicable). Value and tax in 3.1(d); ITC claimed in table 4.',
        authorityRef: ref,
      },
      {
